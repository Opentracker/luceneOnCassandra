...
.getLogger(File.class);
    ...
    public File(String canonicalPath)  {
        // TODO Auto-generated constructor stub
        logger.info("File(String canonicalPath {}", canonicalPath);
        thePrivateFile = new java.io.File(canonicalPath);
        //thePrivateFile = new CassandraFile(null, canonicalPath, "w", true, "lucene0", "index0", 16384);
    }

    public File(File dir, String file) {   // TODO create file in a directory.
        try {
      ...
      //thePrivateFile = new CassandraFile(null, file, "w", true, "lucene0", "index0", 16384);
    }
